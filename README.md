...
## License
The Convergence Admin Console is licensed under the [GNU Public License v3](LICENSE.txt) (GPLv3) license. Refer to the [LICENSE.txt](LICENSE.txt) for the specific terms and conditions of the license.
